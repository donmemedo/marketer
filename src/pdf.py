...
def pdf_maker(shobe='', name='', doreh='', total_fee='', pure_fee='', marketer_fee='', tax='', colat2='', colat='',
    ...
    # add the text to pdf
    #To-Do: Make a Name MarketerName-Year-Month
    doc = SimpleDocTemplate("verbal.pdf", pagesize=letter)
